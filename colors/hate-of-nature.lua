...
set(0, 'Pmenu',           { fg = '#99cc58', bg = '#2C460D' })
set(0, 'PmenuSel',        { fg = '#22350a', bg = '#99cc58' })
...
set(0, "TabLineSel",              { fg = "#22350a", bg = "#99cc58", bold = true })
set(0, "TabLineFill",             { fg = "#22350a", bg = "#162207" })
set(0, "BufferLineTab",           { fg = "#5C842C", bg = "#2C460D" })
set(0, "BufferLineTabSelected",   { fg = "#22350a", bg = "#99cc58", bold = true })
set(0, "BufferLineFill",          { fg = "#365610", bg = "#1C2C09" })
set(0, "BufferLineTabSeparator",  { fg = "#22350a", bg = "#1C2C09" })
set(0, "BufferLineTabSeparatorSelected", { fg = "#99cc58", bg = "#22350a" })
...
set(0, "NvimTreeNormal",        { fg = "#99cc58", bg = "#22350a" })
set(0, "NvimTreeNormalNC",      { fg = "#99cc58", bg = "#22350a" })
set(0, "NvimTreeEndOfBuffer",   { fg = "#22350a", bg = "#22350a" })
set(0, "NvimTreeFolderName",    { fg = "#5C842C", bg = "#22350a" })
set(0, "NvimTreeRootFolder",    { fg = "#A6E22E", bold = true, bg = "#22350a" })
set(0, "NvimTreeVertSplit",     { fg = "#1C2C09", bg = "#1C2C09" })
set(0, "NvimTreeWinSeparator",  { fg = "#1C2C09", bg = "#1C2C09" })
set(0, "NvimTreeIndentMarker",  { fg = "#365610", bg = "#22350a" })
